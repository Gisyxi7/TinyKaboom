...
int main(){
    for(int frame=34;frame<60;frame++){
        sphere_radius=0.525+frame*0.025;
        const int width=640;
        ...
        std::ofstream ofs("./target/gif/frame"+ std::to_string(frame) + ".ppm", std::ios::binary); // save the framebuffer to file
        ofs << "P6\n" << width << " " << height << "\n255\n";
